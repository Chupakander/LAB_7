...
// Выводим сообщение в текстовую область
    ...
    private void sendMessage() {
        try {
            ...
            int indexdot = destinationAddress.indexOf(":");
            String newDA= destinationAddress.substring(0,indexdot);
            String newport= destinationAddress.substring(indexdot);
// Убеждаемся, что поля не пустые
            ...
            final Socket socket = new Socket(newDA, SERVER_PORT);
...
// Помещаем сообщения в текстовую область вывода
            if (turn == true) {
                textAreaIncoming.append("Я -> " + newDA +" порт "+newport+ ": "
                        + message + "\n");
            }
